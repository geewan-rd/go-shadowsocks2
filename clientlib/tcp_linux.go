...
// 	tcpLocal(addr, server, TCPMode, shadow, func(c net.Conn) (socks.Addr, error) { return getOrigDst(c, false) })
// }
...
// 	tcpLocal(addr, server, TCPMode, shadow, func(c net.Conn) (socks.Addr, error) { return getOrigDst(c, true) })
// }
